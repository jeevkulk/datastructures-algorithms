...
public class PatternSearch {
    ...
    public int getFirstOccurrence(String text, String pattern, PatternSearchAlgorithm patternSearchAlgorithm) {
        ...
        if (patternSearchAlgorithm == PatternSearchAlgorithm.KnuthMorrisPratt) {
            firstOccurrence = getFirstOccurrenceUsingKMP(text, pattern);
        } else {
     ...
     * @return
     */
    private int getFirstOccurrenceUsingKMP(String text, String pattern) {
        int firstOccurrence = -1;
